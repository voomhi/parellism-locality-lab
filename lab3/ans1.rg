...
task main()
  ...
  var hits1 = hit(iterations)
  var hits2 = hit(iterations)
  var hits3 = hit(iterations)
  var hits4 = hit(iterations)
  var totalhits = hits1 + hits2 + hits3 + hits4
  c.printf("The area of a unit circle is approximately: %5.4f\n", totalhits / [double](iterations*4) *4)
end
